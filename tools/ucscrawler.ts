...
async function getList(page: number): Promise<number[]> {
...
async function updateData(id: number): Promise<void> {
    ...
    await ucsDocCollection.insertOne({
        _id: `${id}`,
        id,
        time,
        maker: makerName,
